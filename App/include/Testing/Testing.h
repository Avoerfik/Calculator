...
private:
	...
	bool runTest(const std::string& expression,
		const std::string& expected,
		const std::string& testName,
		const unsigned int& testNumber);
	bool runSpecifiedTest(const std::string& expression,
		const std::string& testName,
		const std::string& exceptionName,
		const unsigned int& testNumber);
	void runStandartTestCount(unsigned int& testsTotal,
		...
		const std::string& testName,
		unsigned int& testNumber);
	void runSpecifiedTestCount(unsigned int& testsTotal,
		unsigned int& testsPassed,
		unsigned int& testsFailed,
